/**
 * Unified country-to-dial-code mapping used across both frontend and server generators.
 * Source: ITU-T E.164 international phone numbering plan
 */
...
export const countryDialCodes: CountryDialCode[] = [
  ...
  { code: 'CG', name: 'Congo (Republic of the Congo)', dialCode: '242' },
...
export const getDialCode = (countryCode: string): string => {
  const entry = countryDialCodes.find((c) => c.code === countryCode);
